...
useEffect(() => {
  if (state?.success && state.tenantId && state.companyName) {
    // Store companyName in localStorage for dashboard
    window.localStorage.setItem('companyName', state.companyName);
